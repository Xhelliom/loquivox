...
#
# Vendored verbatim from Pipecat (src/pipecat/audio/turn/smart_turn/_whisper_features.py)
# so Loquivox can compute Smart Turn v3 features with numpy alone — no
# `transformers`, no `torch`. Keep this file in sync with upstream rather than
# editing it; the BSD-2 notice above must stay.
